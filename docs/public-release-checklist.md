...
- [ ] No wet-lab, chemical, acquisition, evasion, or release procedures are included.
- [ ] External links resolve and point to the intended source.
- [ ] Claims about labs, policies, or model behavior are sourced or removed.
